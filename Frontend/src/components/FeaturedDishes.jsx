  ...
  return (
    <section className="featured-dishes">
      <div className="section-top">
        ...
        <button onClick={handleBookClick} className="view-menu" style={{ background: 'transparent', border: 'none', cursor: 'pointer' }}>
          View Full Menu
        ...
        {dishes.map((dish, index) => (
          <div key={index} className="dish-card">
            ...
            <div className="dish-info">
              ...
              <button className="btn-book-dish" onClick={handleBookClick}>Book a Table</button>
            </div>
          </div>
        ))}
      </div>
